...
class Material(Base):
    ...
    blade_str: Mapped[int] = mapped_column(Integer, default=0)
    blade_int: Mapped[int] = mapped_column(Integer, default=0)
    blade_agi: Mapped[int] = mapped_column(Integer, default=0)
    shield_str: Mapped[int] = mapped_column(Integer, default=0)
    shield_int: Mapped[int] = mapped_column(Integer, default=0)
    shield_agi: Mapped[int] = mapped_column(Integer, default=0)
    armor_str: Mapped[int] = mapped_column(Integer, default=0)
    armor_int: Mapped[int] = mapped_column(Integer, default=0)
    armor_agi: Mapped[int] = mapped_column(Integer, default=0)
