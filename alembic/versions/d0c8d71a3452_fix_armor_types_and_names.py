...
down_revision: str | Sequence[str] | None = "2d25d3573fae"
...
def upgrade() -> None:
    ...
    op.execute(
        "UPDATE armor SET field_name = 'Cuisse' WHERE field_name = 'Bandage' AND armor_type = 'Leg'"
    )
    op.execute(
        "UPDATE armor SET field_name = 'Bandage' WHERE field_name = 'Buffle' AND armor_type = 'Arm'"
    )
...
def downgrade() -> None:
    ...
    op.execute(
        "UPDATE armor SET field_name = 'Buffle' WHERE field_name = 'Bandage' AND armor_type = 'Arm'"
    )
    op.execute(
        "UPDATE armor SET field_name = 'Bandage' WHERE field_name = 'Cuisse' AND armor_type = 'Leg'"
    )
